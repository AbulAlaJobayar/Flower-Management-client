...
const DuplicateModal: React.FC<any> = ({ isModalOpen, setIsModalOpen, editId }) => {
  ...
  const [updateData] = useAddProductMutation();
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-start ">
                  ...
                  type="text"
                    ...
                    className="border w-full rounded border-primaryy active:border-secondaryy focus:outline-secondaryy px-2 py-1 text-textColor"
                  >
                    {/* <option value={singleProduct?.data?.color|| 'red'}>Red</option>
